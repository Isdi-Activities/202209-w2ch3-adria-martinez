...
const body = $("body");
const abecedary = $(".abecedary").childNodes;
const inputAnswer = $(".input-answer");
const btnConfirm = $(".btn-confirm");
const btnPasapalabra = $(".btn-pasapalabra");
...
const checkQuestion = () => {
  ...
  if (value.toLowerCase() === question.answer.toLowerCase()) {
    ...
    alert(`La respuesta correcta era: ${question.answer}`);
...
const onPlayButtonClick = () => {
  const panel = $(".page-beginPlay");
  isPlaying = true;
  panel.style.display = "none";
  panel.style.overflow = "auto";
  loadQuestion();
};
const showPanelFinishGame = () => {
  const panel = $(".page-finish-game");
...
const changeColorLetter = (letterToFind, answer) => {
